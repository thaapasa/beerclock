...
enum class DrinkImage(val path: String) : Image {
    ...
    BAILEYS_GLASS_1("drawable/drinks/baileys_glass_1.webp"),
    ...
    CAT_PUNCHES("drawable/categories/cat_punches.webp"),
    ...
    CREAM_LIQUEUR_BOTTLE_1("drawable/drinks/cream_liqueur_bottle_1.webp"),
