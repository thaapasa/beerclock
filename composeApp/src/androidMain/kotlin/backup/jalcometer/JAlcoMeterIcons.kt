...
val jAlcometerIconMapping = mapOf(
    "drink_generic" to DrinkImage.DAIQUIRI_1,
    "drink_fancy" to DrinkImage.COSMOPOLITAN_1,
    "drink_water" to DrinkImage.WATER_GLASS_1,

    // Beers
    "cat_beers" to DrinkImage.BEER_STEIN_1,
    "drink_beer_bottle" to DrinkImage.BEER_BOTTLE_1,
    "drink_beer_bottle2" to DrinkImage.BEER_BOTTLE_2,
    "drink_beer_can" to DrinkImage.BEER_CAN_4,
    "drink_beer_can_blue" to DrinkImage.BEER_CAN_5,
    "drink_beer_pint" to DrinkImage.BEER_STEIN_1,
    "drink_beer_glass" to DrinkImage.BEER_GLASS_1,
    "drink_gin_bottle" to DrinkImage.MIXED_DRINK_BOTTLE_1,
    ...
    "drink_champagne" to DrinkImage.CHAMPAGNE_BOTTLE_1,
    "drink_champagne_glasses" to DrinkImage.CHAMPAGNE_GLASS_1,
    ...
    "drink_cocktail_blue" to DrinkImage.MOCKTAIL_1,
    "drink_long_gt" to DrinkImage.GIN_TONIC_1,
    "drink_irish_coffee" to DrinkImage.IRISH_COFFEE_1,
